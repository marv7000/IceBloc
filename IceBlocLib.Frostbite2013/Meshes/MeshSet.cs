        ...
        for (int i = 0; i < meshSet.Subsets.Length; i++)
        {
            ...
            for (int j = 0; j < meshSet.Subsets[i].Length; j++)
            {
                ...
                for (int k = 0; k < sub.VertexCount; k++)
                {
                    ...
                    vert.BoneIndexA = (short)bIdx[(int)boneIndex.X];
                    vert.BoneIndexB = (short)bIdx[(int)boneIndex.Y];
                    vert.BoneIndexC = (short)bIdx[(int)boneIndex.Z];
                    vert.BoneIndexD = (short)bIdx[(int)boneIndex.W];
